...
Capture research ideas and bugs in the shared GitHub project, then mirror high-priority tasks inside `LAUNCHPAD/next-actions.md`. Each issue should specify:
...
- Source: LAUNCHPAD/next-actions.md (RL-Sim section)
- Acceptance criteria:
...
- Acceptance criteria:
  ...
  - Mark the LAUNCHPAD checklist item complete once the assets exist.
- Status: Completed (Nov 13, 2025).
